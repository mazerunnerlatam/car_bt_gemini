...
const int SENSOR_THRESHOLD_WHITE = 300; // Valor analógico por debajo del cual se considera blanco

// --- Variables Globales ---
int sensorValues; // Array para almacenar lecturas de sensores
float error = 0;
float lastError = 0;
float integral = 0;
float derivative = 0;
